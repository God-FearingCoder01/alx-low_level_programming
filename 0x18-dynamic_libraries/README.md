...
julien@ubuntu:~/0x18. Dynamic libraries$ nm -D --defined-only liball.so0000000000000a90 T _abs
0000000000000aa9 T _atoi
0000000000202048 B __bss_start
0000000000202048 D _edata
0000000000202050 B _end
...
I know, you’re missing C when coding in Python. So let’s fix that!<br>
...
```
 - You can’t modify the program ```gm``` itself as Master Sysadmin Sylvain (MSS) always checks its [MD5](https://intranet.alxswe.com/rltoken/njnwPTMpc1-RSp5sVEAyfg) before running it
